...
function (SuperClass, Enum, BreaseEvent, ErrorHandler, dragAndDropCapability) {
    ...
    p._chartItemsReady = function () {
        ...
        for (xAxisId in this.chartItems.xAxis) { this.chartItems.xAxis[xAxisId]._chartItemsReadyHandler(); }
        for (yAxisId in this.chartItems.yAxis) { this.chartItems.yAxis[yAxisId]._chartItemsReadyHandler(); }
        for (xValuesId in this.chartItems.xValues) { this.chartItems.xValues[xValuesId]._chartItemsReadyHandler(); }
        for (yValuesId in this.chartItems.yValues) { this.chartItems.yValues[yValuesId]._chartItemsReadyHandler(); }
        for (xCursorId in this.chartItems.xCursors) { this.chartItems.xCursors[xCursorId]._chartItemsReadyHandler(); }
